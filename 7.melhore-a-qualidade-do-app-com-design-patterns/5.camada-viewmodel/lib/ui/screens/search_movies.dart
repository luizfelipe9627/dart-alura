...
class SearchMovies extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      // O future é usado para buscar os filmes populares usando o viewModel de busca de filmes.
              ...
              slivers: <Widget>[
                ...
                SliverList.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return MovieCard(
                      // Passa o filme da lista de filmes do viewModel para o MovieCard, então para cada item da lista, o MovieCard será construído com os dados do filme correspondente.
