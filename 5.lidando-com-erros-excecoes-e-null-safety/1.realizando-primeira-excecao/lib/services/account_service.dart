...
class AccountService {
  ...
  String url = "https://api.github.com.br/gists/b693e49bbfde7e0fb5558e2ae9bf6a45";
  ...
  // Função assincrona chamada addAccount responsável por fazer uma requisição HTTP, o async faz que a função só retorne quando a requisição for concluída, recebe um mapa de contas e retorna uma lista de objetos dinâmicos
